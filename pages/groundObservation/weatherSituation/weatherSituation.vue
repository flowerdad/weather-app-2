      ...
      <swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
        <swiper-item class="swiper-item">
          <scroll-view scroll-y>
            <map style="width:100%;height: 40vh;" v-if="mapShow"></map>
            <view style="position:relative;">
              <view id="lmap" style="width:100%;height: 50vh;position:relative;z-index:10"></view>
              <view style="position:absolute;top:100px;left:100px;z-index:20">
                <button plain>披荆</button>
              </view>
            </view>
          </scroll-view>
        </swiper-item>
...
<script>
import vuni from "common/js/uni.js";
export default {
  data() {
    return {
      background: {
  ...
  methods: {
    ...
    timeSubtract() {
      this.timeValue = vuni.uni.timeFormat(vuni.uni.timeSubtract(this.timeValue, 'minutes', 10), "YYYY-MM-DD HH:mm")
    },
    timeAdd() {
      this.timeValue = vuni.uni.timeFormat(vuni.uni.timeAdd(this.timeValue, 'minutes', 10), "YYYY-MM-DD HH:mm")
    },
    timeConfirm(e) {
  ...
  mounted() {
    this.timeValue = vuni.uni.timeFormat(vuni.uni.getMinuteTime(), "YYYY-MM-DD HH:mm")
  }
}
</script>
